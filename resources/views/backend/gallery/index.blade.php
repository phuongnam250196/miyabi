                    ...
                    <div class="card mb-3">
                        <div class="card-header">
                            <span class="pull-right">
                                <!-- <button id="modal_add" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modal_add_slide"><i class="fa fa-plus" aria-hidden="true"></i> Add new image</button> -->
                                <a href="{{ url('admin/gallery/add') }}" class="btn btn-primary btn-sm"><i class="fa fa-plus" aria-hidden="true"></i> Add new image</a>
                            </span>
                                        ...
                                        <form>
                                            ...
                                            <div class="modal-body">
                                                ...
                                                <!-- <div class="row">
                                                   <div class="col-lg-12">
                                                       <div class="form-group">
                                                           <label>Ảnh full màn hình</label>
                                                           <input class="form-control" id="img" name="link" type="file" />
                                                       </div>
                                                   </div>
                                               </div> -->
                                            </div>
                            ...
                            <h3><i class="fa fa-image"></i> All gallery ({{count($data)}} images)</h3>
                        </div>
                        <!-- end card-header -->
                        <div class="card-body">
                            @if(session('messages'))
                                <div class="alert alert-success" role="alert">
                                    <p class="mb-0">{{session('messages')}}</p>
                                </div>
                            @endif
                                        ...
                                        @foreach($data as  $key=>$dat)
                                            <tr id="cate_tr_{{ $dat->id }}">
                                                ...
                                                <td>
                                                    ...
                                                    <a href="{{ url('/admin/gallery/update/'.$dat->id) }}" class="btn btn-primary btn-sm btn_edit mr-1" ><i class="fa fa-pencil" aria-hidden="true"></i></a>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('body').on('click', '#modal_add', function() {
                $('#modal_add_slide').find('.modal-title').text('Add image gallery');
            ...
            $('body').on('click', '.btn_edit', function() {
                ...
                $('#modal_add_slide').find('.modal-title').text('Update image gallery');
