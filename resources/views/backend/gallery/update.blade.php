            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="breadcrumb-holder">
                        <h1 class="main-title float-left">Cập nhật ảnh gallery</h1>
                        <ol class="breadcrumb float-right">
                            <li class="breadcrumb-item">Home</li>
                            <li class="breadcrumb-item active">Cập nhật ảnh gallery</li>
                        </ol>
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Title</label>
                                            <input class="form-control" name="title" type="text" placeholder="Title image" value="{{$data->title}}" />
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <img id="avatar" class="thumbnail" src="{{url('/'.$data->link)}}" width="250">
                                           @if($errors->has('link'))
